...
const Organizations = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen text-[#031C44]">
        Loading...
      </div>
    );
  }
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 bg-[#FAFBFD]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <h2 className="text-2xl font-bold text-[#052490] mb-2">
            Welcome to Learn Social Studies
          </h2>
          {currentOrganization && (
            <div className="text-md text-[#031C44] mb-6">
